...
class QuizApp:
    def __init__(self, root, questions, test_id):
        self.root = root
        ...
        self.font_bold = ("Helvetica", 40, "bold")
    ...
    def submit_answer(self, event=None):
        ...
        if correct:
            ...
            self.missed_questions.append(current_question["question"])
...
if __name__ == "__main__":
    ...
    # Test 1
    root1 = tk.Tk()
    app1 = QuizApp(root1, questions_set_1, 1)
    root1.mainloop()

    # Test 2
    root2 = tk.Tk()
    app2 = QuizApp(root2, questions_set_2, 2)
    root2.mainloop()
